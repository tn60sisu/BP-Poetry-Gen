...
params = {'classifier': ['CLR'], 'LSTM-Size': [100, 100], 'dropout': (0.25, 0.25),
          'featureNames': ['tokens', 'sent_1'], 'addFeatureDimensions': 10}
